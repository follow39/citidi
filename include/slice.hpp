...
struct ArrayMaker {
  ...
  template <
      std::size_t AI, std::size_t AS, std::size_t DI, std::size_t DS,
      typename D, typename C,
      std::enable_if_t<!(C::template Evaluate<typename std::tuple_element_t<
                             DI, D>::MarkerTypesTupleType>()),
                       bool> = true>
